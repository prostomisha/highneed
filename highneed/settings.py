"""
Django settings for highneed project.
...
SECRET_KEY = '-*j*-jnwp#k+p8!4%8tgcz-#6nnsz3$rtqy(3zr_53@8_4)&gx'
...
WSGI_APPLICATION = 'highneed.wsgi.application'
